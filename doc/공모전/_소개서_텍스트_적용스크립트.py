...
FEATURES = [
    (5, '경북 전통문화 통합 탐색',
     ...
     ['1. 카테고리 화면에서 카테고리를 고른다.',
      '2. 조건 바에서 지역(시군)과 정렬을 좁힌다.',
      '3. 경북 특화 키워드로 검색하거나 ‘무장애’만 본다.',
      '4. 목록과 지도에서 결과를 확인한다.']),
